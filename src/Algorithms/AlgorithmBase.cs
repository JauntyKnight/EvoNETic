...
#nullable enable
        ...
        {
            Console.WriteLine(String.Format("{0, -5} | {1, -5} | {2, -10} | {3, -10} | {4, -10}", generation + 1, TimeElapsed, population.First().Fitness, population.Last().Fitness, BestChromosome.Fitness));
        }
    }
}
